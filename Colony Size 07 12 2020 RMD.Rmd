...
```{r}
Read_in3 <- read_delim("Data/WT_ybeX_MOPS_ON_colonysize3.csv", 
    ",", escape_double = FALSE, locale = locale(grouping_mark = ""), 
    trim_ws = TRUE)
```
...
```{r}
WTall <- read_delim("Data/WT_ybeX_MOPS_ON_colonysize3.csv", 
    ",", escape_double = FALSE, locale = locale(grouping_mark = ""), 
    trim_ws = TRUE)
```
...
```{r}
ybeX1 <- read_delim("Data/ybeX_MOPS_ON_colonysize1.csv", 
    ",", escape_double = FALSE, locale = locale(grouping_mark = ""), 
    trim_ws = TRUE)
```
...
ggplot(Readall)+ geom_histogram(aes(Size, color=Strain, bin=30))+
